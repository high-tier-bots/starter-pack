#(©)HighTierBots - Broadcast Service
...
async def broadcast_to_all(message):
  """Broadcast a reply message to all users in the database."""
  ...
  logger.info(
    "Broadcast completed - "
    f"Success: {stats['success']}, Blocked: {stats['blocked']}, Deleted: {stats['deleted']}"
  )
